-- Supabase RLS (Row Level Security) Düzeltme Scripti - Tam Versiyon
-- Bu script tüm mevcut tablolar için RLS'yi etkinleştirir ve güvenlik politikalarını oluşturur
